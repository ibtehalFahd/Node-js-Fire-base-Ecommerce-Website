...
exports.createUser=(un,email,phone,pass)=>{
           ...
           .then(user=>{
               console.log('in');
                ...
                admin.auth().createUser({
                    ...
                    password: pass,
                    displayName: un,
                    photoURL: "https://firebasestorage.googleapis.com/v0/b/e-commerce-8b449.appspot.com/o/images%2Fprofile.jpg?alt=media&token=5e2a7d74-5cfc-4624-95e0-28ef177fb88f",
                    disabled: false
                  }).then(()=>{
                    console.log('resolve')
                        resolve()
